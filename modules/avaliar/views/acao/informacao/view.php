...
<div class="informacao-view-only-reading">
    <p class="mb-1">
        <span class="font-weight-semi-bold"><?= $modelAcao->getAttributeLabel('eixo') ?>:</span>

        <?= $modelAcao->eixo->titulo ?>
    </p>

    <p class="mb-1">
        <span class="font-weight-semi-bold"><?= $modelAcao->getAttributeLabel('subeixo') ?>:</span>
    ...
    <p class="mb-1">
        <span class="font-weight-semi-bold"><?= $modelAcao->getAttributeLabel('objetivo') ?>:</span>
    ...
    <div class="card border-primary bw-3 mb-0">
        <div class="card-body">
            <p class="mb-1">
                <span class="font-weight-semi-bold"><?= $modelAcao->getAttributeLabel('classificacao') ?>:</span>

                <?= Universal::valueField($modelAcao->classificacao, null, true) ?>
            </p>

            <p class="mb-1">
                <span class="font-weight-semi-bold"><?= $modelAcao->getAttributeLabel('tipo') ?>:</span>

                <?= Universal::valueField(implode(', ', $tipoNomes), null, true) ?>
            </p>

            <p class="mb-1">
                <span class="font-weight-semi-bold"><?= $modelAcao->getAttributeLabel('previsao_inicio') ?></span>

                <?= Universal::valueField($modelAcao->previsao_inicio, null, true) ?>
            </p>

            <p class="mb-1">
                <span class="font-weight-semi-bold"><?= $modelAcao->getAttributeLabel('previsao_conclusao') ?>:</span>

                <?= Universal::valueField($modelAcao->previsao_conclusao, null, true) ?>
            </p>

            <p class="mb-1">
                <span class="font-weight-semi-bold"><?= $modelAcao->getAttributeLabel('orcamento_previsto') ?>:</span>
