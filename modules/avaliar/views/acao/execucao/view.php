...
<div class="execucao-view-only-reading">
    <div class="card border-primary bw-3 mb-0">
        <div class="card-body">
            <p class="mb-1">
                <span class="font-weight-semi-bold"><?= $modelAcao->getAttributeLabel('status') ?>:</span>

                <?= Status::getAcaoStatus($modelAcao->status) ?>
            </p>

            <p class="mb-1">
                <span class="font-weight-semi-bold"><?= $modelAcaoExecucao->getAttributeLabel('data_inicio') ?>:</span>
            ...
            <p class="mb-1">
                <span class="font-weight-semi-bold"><?= $modelAcaoExecucao->getAttributeLabel('observacoes') ?>:</span>
                ...
                <div class="card-body">
                    ...
                    <p class="mb-1">
                        ...
                        <?php if ($modelAcaoExecucao->acaoExecucaoArquivos) : ?>
                            <?php $modelAcaoExecucaoArquivos = $modelAcaoExecucao->acaoExecucaoArquivos; ?>

                            <?php foreach ($modelAcaoExecucaoArquivos as $index => $modelAcaoExecucaoArquivo) : ?>
                                <?php $arquivo = $modelAcaoExecucaoArquivo->arquivo; ?>
            ...
            <p class="mb-1">
                <span class="font-weight-semi-bold"><?= $modelAcaoExecucao->getAttributeLabel('processo_sei') ?>:</span>
