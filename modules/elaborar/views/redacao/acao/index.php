...
<div class="acao-index">
    ...
    <?php Pjax::begin(); ?>
        <?= GridView::widget([
            ...
            'tableOptions' => ['class' => 'table table-striped table-bordered mb-3'],
            ...
            'columns' => [
                ...
                [
                    'attribute' => 'subeixo_id',
                    'value' => function ($model) {
                        return Universal::valueField($model->subeixo, 'titulo');
                    }
                ],
                'numero',
                'titulo',
