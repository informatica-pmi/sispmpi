...
class m140506_102106_rbac_init extends \yii\db\Migration
{
    ...
    public function up()
    {
        ...
        if ($this->db->getTableSchema($authManager->ruleTable, true) === null) {
            ...
            $this->execute("ALTER TABLE {$authManager->ruleTable} ADD PRIMARY KEY([[name]])");
        }

        if ($this->db->getTableSchema($authManager->itemTable, true) === null) {
            ...
            $this->execute("ALTER TABLE {$authManager->itemTable} ADD PRIMARY KEY([[name]])");

            $this->execute(
                "ALTER TABLE {$authManager->itemTable} 
                ADD FOREIGN KEY ([[rule_name]]) 
                REFERENCES {$authManager->ruleTable} ([[name]])
                ON DELETE SET NULL 
                ON UPDATE CASCADE"
            );
        ...
        if ($this->db->getTableSchema($authManager->itemChildTable, true) === null) {
            ...
            $this->execute("ALTER TABLE {$authManager->itemChildTable} ADD PRIMARY KEY([[parent]], [[child]])");

            $this->execute(
                "ALTER TABLE {$authManager->itemChildTable} 
                ADD FOREIGN KEY ([[parent]]) 
                REFERENCES {$authManager->itemTable} ([[name]])
                ON DELETE CASCADE 
                ON UPDATE CASCADE"
            );
        ...
        if ($this->db->getTableSchema($authManager->assignmentTable, true) === null) {
            ...
            $this->execute("ALTER TABLE {$authManager->assignmentTable} ADD PRIMARY KEY([[item_name]], [[user_id]])");

            $this->execute(
                "ALTER TABLE {$authManager->assignmentTable} 
